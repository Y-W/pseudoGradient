...
def build_cnn(input_var=None, n=5):
    ...
    def residual_block(l, increase_dim=False):
        ...
        stack_1 = batch_norm(ConvLayer(l, num_filters=out_num_filters, filter_size=(3,3), stride=first_stride, nonlinearity=tanh, pad='same', W=lasagne.init.HeNormal(gain='relu'), flip_filters=False))
    ...
    l = batch_norm(ConvLayer(l_in, num_filters=16, filter_size=(3,3), stride=(1,1), nonlinearity=tanh, pad='same', W=lasagne.init.HeNormal(gain='relu'), flip_filters=False))
